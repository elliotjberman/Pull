...
public enum SurfaceArea
{
    ...
    /** Four Bitwig-mappable control pads at columns 4-7 on row 3. */
    DRUM_USER_CONTROL_PADS (gridRectangle (4, 3, 4, 1), Set.copyOf (CoreControls.DRUM_USER_CONTROLS), Set.of (InputKind.PAD)),
