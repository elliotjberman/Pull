...
public final class PullCoreProvider implements CoreProvider
{
    ...
    public static final int STATE_SCHEMA_VERSION = 6;
    ...
    private static final ShellCapabilities REQUIRED_CAPABILITIES = new ShellCapabilities (Map.ofEntries (
        ...
        Map.entry (CoreCapabilities.ROUTING_CONTROLLER_INPUT, Integer.valueOf (10)),
        Map.entry (CoreCapabilities.SNAPSHOT_CONTROLLER_BRIDGE, Integer.valueOf (17)),
