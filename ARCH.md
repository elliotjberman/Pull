...
| Retained Device pages | Two pinned child devices, each with a named independent eight-remote page. Opaque child generations, later device/parameter equality, observed invalidation revisions; retiring cleanup keeps its own resource. |
