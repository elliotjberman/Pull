...
| Stale deferred page effects disabling core | Master, Automation and Metronome could submit a frozen effect after its origin changed. Production preparation would reject it and quarantine the active core. | Review A1 corrected, including the equivalent global mixer menu. Six real core/runtime/bridge cases and fresh-action recovery pass; a unit test had previously asserted the production-invalid result. |
