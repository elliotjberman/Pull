...
public record ControllerSettingsSnapshot (boolean available, boolean vuMetersEnabled, String globalMixMode, int mixSendOffset, CursorSendBankSnapshot cursorSends, boolean accentEnabled, int accentVelocity)
{
