 ...
 */
public sealed interface CoreEvent permits ButtonInputEvent, ControllerActionEvent, ControllerInputEvent, ControllerTickEvent, ParameterMutationEvent, SnapshotChangedEvent, TimerElapsedEvent, TouchInputEvent
{
    /**
