 ...
 */
public sealed interface CoreEvent permits ButtonInputEvent, ControllerActionEvent, ControllerInputEvent, ControllerTickEvent, ParameterMutationEvent, SnapshotChangedEvent, TouchInputEvent
{
    /**
