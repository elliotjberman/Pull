 ...
 */
public sealed interface CoreEvent permits ButtonInputEvent, ControllerInputEvent, ControllerTickEvent, ParameterMutationEvent, SnapshotChangedEvent, TimerElapsedEvent, TouchInputEvent
{
    /**
