...
/** Request one bounded current-project file action. */
public record ProjectFileActionEffect (String expectedProjectIdentity, ProjectFileAction action) implements CoreEffect
{
    public ProjectFileActionEffect
    {
