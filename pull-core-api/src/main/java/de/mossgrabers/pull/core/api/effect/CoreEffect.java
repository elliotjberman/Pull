 ...
 */
public sealed interface CoreEffect permits SetCurrentParameterValueEffect, SessionActionEffect, CopySessionClipEffect, CreateSessionClipEffect, SetSessionBankPositionEffect, SetApplicationLayoutEffect, ToggleApplicationPanelEffect, SetArrangerBooleanEffect, SetMixerBooleanEffect, CurrentTrackNavigationEffect, SetControllerBooleanSettingEffect, SetControllerIntegerSettingEffect, SetControllerModeSettingEffect, SetTransportSettingEffect, SetPreRollEffect, SetAutomationModeEffect, ResetAutomationOverridesEffect, CurrentTrackActionEffect, NavigateTrackParentEffect, SetCurrentTrackBooleanEffect, ProjectHistoryEffect, SetParameterNormalizedValueEffect, AcquireParameterTouchEffect, SetParameterEnabledEffect, TapTempoEffect, SetDrumBankPositionEffect, ShowHostNotificationEffect, SetAutomationWriteEffect, AdjustParameterValueEffect, ConsumeControllerButtonEffect, NavigateProjectEffect, PressClipTargetEffect, ProjectFileActionEffect, ReleaseClipTargetsEffect, ResetParameterEffect, SelectDrumPadEffect, SelectSessionTrackEffect, SelectedTrackActionEffect, SendNoteInputMidiEffect, SetControllerMappingStorageEffect, SetDrumPadBooleanEffect, SetDrumPadValueEffect, SetNoteViewPreferenceEffect, SetParameterValueEffect, SetProjectEngineEffect, SetProjectTransportStateEffect, SetSelectedTrackBooleanEffect, SetSelectedTrackMonitorEffect, SetSelectedTrackValueEffect, SetTransportStateEffect, SetTransportValueEffect, StopSessionBankEffect, StopSessionTrackEffect
{
